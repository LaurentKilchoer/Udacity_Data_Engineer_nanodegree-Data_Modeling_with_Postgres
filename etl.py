...
def process_data(cur, conn, filepath, func):
    """
    Loads data from songs and event log files into postgres database
    :param cur: database cursor reference
    :param conn: database connection reference
    :param filepath: parent directory where the files are located
...
def main():
    """
    Loads songs and log data into postgres database
    """
